...
The attested subjects are the raw platform binary, the platform bundle, and the
release hash manifest generated for that platform. The helper script
...
output with normalized timestamps and metadata. If Tauri's NSIS bundler does not
