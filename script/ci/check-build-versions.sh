...
check_contains .github/workflows/publish.yml './script/ci/configure-repro-makensis.sh'
...
check_contains .github/workflows/publish-smoke.yml './script/ci/configure-repro-makensis.sh'
...
check_contains src-tauri/tauri.conf.json '"beforeBundleCommand": "deno run -A ./script/ci/normalize-bundle-inputs.ts"'
